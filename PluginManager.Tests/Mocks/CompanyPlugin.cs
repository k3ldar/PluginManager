 ...
 *  
 *  File: CompanyPlugin.cs
 *
 *  Purpose:  Mock plugin for testing (simulates a company plugin with resources)
 *
 *  Date        Name                Reason
...
namespace PluginManager.Tests.Mocks
{
    ...
    public class CompanyPlugin : IPlugin
    {
        public void ConfigureServices(IServiceCollection services)
        {
            // Mock implementation - services configuration for Company plugin
        }
